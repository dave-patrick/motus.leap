...
function renderPlaylistsGrid(playlists) {
  ...
  <div class="flex-shrink-0 w-24 md:w-28">
    <img src="${p.thumbnail || 'https://picsum.photos/160/90'}" class="w-full h-auto object-cover" style="aspect-ratio: 16/9;" onerror="this.onerror=null; this.src='https://picsum.photos/160/90'">
  </div>
