...
function renderPlaylistsGrid(playlists) {
 ...
 <div class="w-24 md:w-28 flex-shrink-0"><img src="${p.thumbnail || 'https://picsum.photos/160/90'}" class="w-full h-auto" style="aspect-ratio: 16/9;" onerror="this.onerror=null; this.src='https://picsum.photos/160/90'"></div>
