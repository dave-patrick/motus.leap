...
function renderPlaylistsGrid(playlists) {
    ...
    playlistsList.innerHTML = playlists.map(p => `
        <div onclick="window.location.href='/playlist/${p.id}'" class="bento-card p-[18px] max-w-2xl flex flex-col cursor-pointer hover:border-[#2a7db8]/50 transition-colors h-full relative">
