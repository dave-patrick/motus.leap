        ...
        <a href="/playlist/${p.id}" class="bento-card p-3 md:p-4 w-full flex flex-row gap-3 cursor-pointer hover:border-[#2a7db8]/50 transition-colors items-center relative block">
          ...
          <div class="flex-1 min-w-0 flex flex-col gap-1">
            ...
            <div class="flex items-center gap-2 mt-1" onclick="event.stopPropagation()">
              ...
              <button onclick="event.preventDefault(); event.stopPropagation(); openManagePlaylistModal('${p.id}', '${safeTitle}', event)" class="flex-1 bg-[#20242c] hover:bg-[#2a2f3a] border border-[#2a2f3a] text-gray-300 text-xs py-1.5 px-2 rounded transition-colors"><i class="fa-solid fa-cog text-[10px]"></i> Manage</button>
            </div>
          </div>
